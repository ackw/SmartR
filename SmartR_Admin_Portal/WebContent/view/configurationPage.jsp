                ...
                <div class="card-body">
                    <form action="#!">
                      <div class="form-group">
                        ...
                        <div id="operatingHours" class="form-group form-inline mb-1">
                            <div class="input-group ml-3">
                              <input type="time" name="StartTime" id="StartTime" value="09:30:00" class="form-control" value="${Opening_hours}">
                              <div class="input-group-prepend"><span class="divider">to</span></div>
                              <input type="time" name="EndTime" id="EndTime" value="17:30:00" class="form-control" value="${Closing_hours}">
                            </div>
                            <div class="form-check ml-3 mb-3">
                                <input type="checkbox" class="form-check-input" id="CheckBox" value="${IsClosed}">
                                <label class="form-check-label" for="CheckBox">Closed</label>
                             </div>                        
                          </div>
                      ...
                      <div id="selectDay" class="form-group form-inline mb-6">
                        <button type="button" class="btn btn-primary" value="${day}">Mon</button>
                        <button type="button" class="btn btn-primary ml-2" value="${day}">Tues</button>
                        <button type="button" class="btn btn-primary ml-2" value="${day}">Wed</button>
                        <button type="button" class="btn btn-primary ml-2" value="${day}">Thurs</button>
                        <button type="button" class="btn btn-primary ml-2" value="${day}">Fri</button>
                        <button type="button" class="btn btn-primary ml-2" value="${day}">Sat</button>
                        <button type="button" class="btn btn-primary ml-2" value="${day}">Sun</button>
                      </div>
                      
                      <div class="form-group mt-3">
                          <p>Grace Period:</p>
                        <select class="form-control" id="grace_period" placeholder="Grace Period" value="${grace_period}">
                      ...
                      <input name="submit" id="submit" class="btn btn-block submit-btn mb-4" type="submit" value="Save">
                    </form>
                </div>
            </div>
             </div>
