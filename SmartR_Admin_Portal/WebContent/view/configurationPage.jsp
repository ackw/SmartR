...
<script type="text/javascript" src="js/toggleday.js"></script>
						...
						<form action="#!">
							<div class="form-group">
								...
								<div id="tuesday" class="form-group form-inline mb-1">
									...
									<div class="form-check ml-3 mb-3">
										<input type="checkbox" class="form-check-input"
											id="tueCheckBox"> <label class="form-check-label"
											for="tueCheckBox">Closed</label>
									</div>
								</div>
							...
							<div id="selectDay" class="form-group form-inline mb-6">
								...
								<button id = "tuebtn" type="button" class="btn btn-primary ml-2">Tues</button>
								<button id = "wedbtn" type="button" class="btn btn-primary ml-2">Wed</button>
								<button id = "thubtn" type="button" class="btn btn-primary ml-2">Thurs</button>
